    ...
    <div data-scroll-section className="pt-25 pb-16">
      ...
      {mostrarModal && (
        <div 
          ...
          onClick={() => setMostrarModal(false)} // Cierra al hacer clic fuera
        >
          {/* Este div actúa como el contenedor principal para la imagen del modal */}
          {/* Debe ser relative para que Image fill funcione, y debe tener un tamaño */}
          <div 
            className="relative w-full h-full max-w-screen-xl max-h-screen-xl" // Añado w-full h-full y max-w/h para que ocupe espacio
            onClick={e => e.stopPropagation()}
          >
            <Image 
              src={imagenActual} 
              alt="Imagen en pantalla completa" 
              fill // ¡CRUCIAL! Para que ocupe el contenedor padre (este div)
              className="object-contain" // Para que la imagen se muestre completa sin recortes
            />
            {/* Botón de cerrar */}
            <button
      ...
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {/* Imagen principal */}
            {/* CORRECCIÓN: Se añade 'relative' y se usa fill/object-contain con una altura fija h-96 */}
            <div 
            ...
            <div className="grid grid-cols-3 md:grid-cols-4 gap-3">
              {vehiculo.imagenes.map((img, index) => (
                <div 
                  ...
                  // CORRECCIÓN: Se añade 'relative w-full h-24' para definir el tamaño y la posición
