const navigation = {
  ...
  legal: [
    { name: "Servicio de Asesoria personalizada", href: "#" },
    { name: "Servicio de importacion de repuestos", href: "#" },
    { name: "Servicio de inspeccion mecanica", href: "#" },
  ],
  social: [
    {
      name: "Facebook",
...
function Footer() {
  return (
    <footer className="bg-[#F29F05]" aria-labelledby="footer-heading">
      ...
      <div className="mx-auto max-w-full py-12 px-4 sm:px-6 lg:py-16 lg:px-8">
        <div className="xl:grid xl:grid-cols-3 xl:gap-8">
          ...
          <div className="mt-12 grid grid-cols-3 gap-8 xl:col-span-2 xl:mt-0">
            ...
            <div>
              <h3 className="text-base  text-gray-900 font-bold">Empresa</h3>
              <ul role="list" className="mt-4 space-y-4">
            ...
            <div>
              <h3 className="text-base  text-gray-900 font-bold">Servicios</h3>
              <ul role="list" className="mt-4 space-y-4">
        ...
        <div className="mt-12 border-t border-orange-200 pt-8">
          <p className="text-base text-gray-900 xl:text-center">
            &copy; 2025 Caltimer Group, Inc. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
